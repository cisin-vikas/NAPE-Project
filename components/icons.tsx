...
export const BeakerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.368-.823a2 2 0 01-1.022-.547L12 10.5l-2.992 2.992a2 2 0 01-1.022.547l-2.368.823a2 2 0 00-1.022.547M12 18V3m-3.293 15.293l1.414 1.414a2 2 0 002.828 0l1.414-1.414M5 21h14a2 2 0 002-2v-7a2 2 0 00-2-2H5a2 2 0 00-2 2v7a2 2 0 002 2z" />
    </svg>
);
